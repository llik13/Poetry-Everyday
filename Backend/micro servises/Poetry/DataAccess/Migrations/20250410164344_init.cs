    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PoemNotifications", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SavedPoems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SavedPoems_Collections_CollectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PoemsId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryPoem", x => new { x.CategoriesId, x.PoemsId });
                    table.ForeignKey(
                        name: "FK_CategoryPoem_Categories_CategoriesId",
                        column: x => x.CategoriesId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryPoem_Poems_PoemsId",
                        column: x => x.PoemsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PoemStatistics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PoemStatistics_Poems_PoemId",
                        column: x => x.PoemId,
                        principalTable: "Poems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PoemTag", x => new { x.PoemsId, x.TagsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PoemStatistics_PoemId",
                table: "PoemStatistics",
                column: "PoemId",
                unique: true);
